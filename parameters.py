...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        pretrained_model_weights='D:/tutorials/University/AASP/proposal/dataset/SELD - DCASE/2023/models/6_1_dev_split0_multiaccdoa_mic_gcc_model.h5',
        ...
        model_dir='D:/tutorials/University/AASP/proposal/dataset/SELD - DCASE/2023/models',            # Dumps the trained models and training curves in this folder
        dcase_output_dir='D:/tutorials/University/AASP/proposal/dataset/SELD - DCASE/2023/results',    # recording-wise results are dumped in this path.
        ...
        # added param:
        t_pooling_loc = 'front',
        # nb_cnnTrans2d_filt_in = [64, 64, 64],
        # nb_cnnTrans2d_filt_out = [64, 64, 10],
        # nb_cnn2d_filt=32,
    ...
    # #     params['unique_classes'] = 14 # for uav_mixture = 14
    # elif '2023' in params['dataset_dir']:
    params['unique_classes'] = 14
